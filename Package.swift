...
let package = Package(
  ...
  dependencies: [
    .package(url: "https://github.com/tanaev/swift-verge", exact: "14.1.3"),
  ...
  targets: [
    .target(
      ...
      dependencies: [.product(name: "Verge", package: "swift-verge")]
    ),
    .target(
      name: "BrightroomUI",
      dependencies: ["BrightroomEngine", .product(name: "Verge", package: "swift-verge"), "TransitionPatch"]
    ),
    .target(
